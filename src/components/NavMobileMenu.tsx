...
const NavMobileMenu = ({ navLinks, language, onNavClick }: NavMobileMenuProps) => (
  <div className="md:hidden bg-white dark:bg-black border-t border-gray-200 dark:border-gray-800 px-4 py-4">
      ...
      {navLinks.map((link) => (
        <li key={link.id}>
          <a
            ...
            className="block text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors py-1"
          >
            {link.label}
          </a>
        </li>
